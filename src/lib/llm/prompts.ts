...
- Write 3–5 lines max, third person implied.
- Cut generic buzzwords — state the core substance only. Prefer metrics over adjectives.
- Every claim must also appear in the experience content.
- NEVER hallucinate numbers.
- Write in output_language when provided.
